    ...
    >
      ...
      {Array.from({ length: _values.length }, (_, index) => (
        <SliderPrimitive.Thumb
          ...
          key={index}
          className="border-primary/30 ring-ring/50 block size-5 shrink-0 rounded-full border-2 bg-primary shadow-md transition-[color,box-shadow] hover:ring-4 hover:shadow-lg focus-visible:ring-4 focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-50"
        />
      ))}
    </SliderPrimitive.Root>
  )
